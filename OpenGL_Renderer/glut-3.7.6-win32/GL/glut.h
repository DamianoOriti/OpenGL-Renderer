...
GLUTAPI void APIENTRY glutInitWindowSize(int width_, int height_);
...
#endif
#endif
GLUTAPI int APIENTRY glutCreateSubWindow(int win, int x, int y, int width_, int height_);
...
GLUTAPI void APIENTRY glutReshapeWindow(int width_, int height_);
...
GLUTAPI void APIENTRY glutReshapeFunc(void (GLUTCALLBACK *func)(int width_, int height_));
...
GLUTAPI void APIENTRY glutWireCone(GLdouble base, GLdouble height_, GLint slices, GLint stacks);
GLUTAPI void APIENTRY glutSolidCone(GLdouble base, GLdouble height_, GLint slices, GLint stacks);
...
GLUTAPI void APIENTRY glutVideoResize(int x, int y, int width_, int height_);
GLUTAPI void APIENTRY glutVideoPan(int x, int y, int width_, int height_);
